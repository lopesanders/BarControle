  ...
  return (
    <div className="p-7 space-y-10 animate-slide-up pb-24">
      <div className="flex justify-between items-center px-1">
        ...
        <div className="px-3 py-1.5 bg-emerald-50 dark:bg-emerald-900/20 text-emerald-600 dark:text-emerald-400 rounded-full text-[9px] font-black uppercase tracking-[0.2em] flex items-center gap-1.5 border border-emerald-100 dark:border-emerald-900/10">
        ...
        <div className="p-8 bg-slate-100 dark:bg-dark-card rounded-[2.5rem] border border-slate-200 dark:border-dark-border text-center space-y-5 shadow-inner">
          <div className="flex flex-col items-center">
             ...
             <p className="text-xs font-medium text-slate-500 dark:text-slate-400 italic leading-relaxed px-4">
               "Controle seus gastos com inteligência e aproveite a noite sem surpresas."
             </p>
          </div>
